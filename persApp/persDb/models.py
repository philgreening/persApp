...
class PeriodicalsOctavo(models.Model):
    mms_id = models.TextField(max_length=255, null=False, blank=False)
    issn = models.TextField(max_length=255, null=True, blank=True)
    library_name = models.CharField(max_length=50, null=False, blank=False)
    new_library = models.CharField(max_length=20, null=True, blank=True)
    location_name = models.CharField(max_length=50, null=False, blank=False)
    new_location = models.CharField(max_length=50, null=True, blank=True)
    classmark = models.CharField(max_length=50, null=True, blank = True)
    new_per_number = models.CharField(max_length=20, null=True, blank=True)
